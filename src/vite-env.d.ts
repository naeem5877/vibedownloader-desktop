...
interface Window {
    electron: {
        ...
        downloadVideo: (params: { url: string; formatId: string; title: string; platform?: string; contentType?: string }) => Promise<any>;
        downloadSpotifyTrack: (params: { searchQuery: string; title: string; artist: string }) => Promise<any>;
